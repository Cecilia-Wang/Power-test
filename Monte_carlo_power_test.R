...
# randomly select a number of samples (columns) as a subgroup containing, 10 ~ 100 by 10
# make that a function to randomly select samples with two runs of test on 10 samples, use e. coli as a test for sampling depth of 10 per group
